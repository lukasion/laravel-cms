...
return array(
    ...
    'Text_filter' => 'wpisz frazę',
    'Swipe_help' => 'Kliknij w nazwę pliku/folderu by wyświetlić dostępne opcje',
    'Upload_base' => 'Wgrywanie z dysku',
    'Upload_base_help' => "Przeciągnij i upuść pliki lub kliknij w przycisk Dodaj pliki, a następnie Wgraj pliki. Na końcu kliknij Powrót do listy plików.",
    'Upload_add_files' => 'Dodaj pliki',
    'Upload_start' => 'Wgraj pliki',
    'Upload_error_messages' =>array(
        1 => 'The uploaded file exceeds the upload_max_filesize directive in php.ini',
        2 => 'The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form',
        3 => 'The uploaded file was only partially uploaded',
        4 => 'Żaden plik nie został wgrany',
        6 => 'Nie znaleziono folderu tymczasowego',
        7 => 'Zapis pliku zakończył się błędem',
        8 => 'A PHP extension stopped the file upload',
        'post_max_size' => 'The uploaded file exceeds the post_max_size directive in php.ini',
        'max_file_size' => 'Plik jest zbyt duży',
        'min_file_size' => 'Plik jest zbyt mały',
        'accept_file_types' => 'Rozszerzenie pliku nie jest obsługiwane',
        'max_number_of_files' => 'Maksymalna liczba plików została przekroczona',
        'max_width' => 'Obrazek przekracza maksymalną szerokość',
        'min_width' => 'Obrazek nie osiąga minimalnej szerokości',
        'max_height' => 'Obrazek przekracza maksymalną wysokość',
        'min_height' => 'Obrazek nie osiąga minimalnej wysokości',
        'abort' => 'Przesyłanie pliku zostało przerwane',
        'image_resize' => 'Zmiana rozmiaru obrazka zakończyła się niepowodzeniem'
    ),
    'Upload_url' => 'Wgrywanie z linku zewnętrznego',
    'Type_dir' => 'FLD',
    'Type' => 'Rozszerzenie',
    'Dimension' => 'Rozmiar',
    'Size' => 'Wielkość',
