<footer class="text-gray-300">
    @if (!isset($withoutForm))
        <div class="form__container" id="bestill-na">
            <div class="container">
                ...
                <div class="flex items-center flex-col">
                    <div class="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4 w-full md:w-2/3">
                        <div>
                            <label class="text-xs">Navnet ditt</label>
                        ...
                        <div>
                            <label class="text-xs">Telefonnummer</label>
                            <input class="form-control block w-full px-4 py-2 text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" />
                        </div>
                    </div>
                    <div class="mt-6 grid grid-cols-1 w-full md:w-2/3">
                        <div>
                            <label class="text-xs">Beskjed</label>
                    ...
                    <div class="mt-6 grid grid-cols-1 w-full md:w-2/3">
                        <div class="text-center">
                            <button type="submit" class="header__button">Sende</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="footer__bottom">
        <p class="text-center text-gray-500 text-xs">Copyright &copy; {{ date("Y") }} - created by <a href="https://github.com/lukasion" target="_blank">ellukasion</a></p>

        @if (Auth::check())
            <p class="text-center mt-5">
                <a class="bg-gray-700 hover:bg-gray-500 cursor-pointer transition-all w-full text-white font-semibold py-2 px-4 rounded" href="{{ route('userLogin') }}">Logg ut</a>
